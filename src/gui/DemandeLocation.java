...
public class DemandeLocation {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				Locataire locataire = new Locataire("p", "p", "p");
				try {
	 ...
	 */
	public DemandeLocation(Locataire locataire) {
	...
	private void initialize(Locataire locataire) {
		...
		frame = new JFrame();
		frame.setTitle("Demander une location");
		...
		JLabel lblEspaceBailleur = new JLabel("ESPACE LOCATAIRE");
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//Retour à l'ouverture de la fenêtre de l'espace Locataire
				try {
		...
		JLabel lblInfosBails = new JLabel("INFOS BIENS");
		...
		lblInfosBails_2_10_1.setBounds(281, 218, 78, 34);
		...
		lblInfosBails_2_1_9_1.setBounds(393, 217, 52, 34);
		panel_2.add(lblInfosBails_2_1_9_1);

		JLabel lblInfosBails_2_11_3_1 = new JLabel("FREQUENCE LOYER");
		lblInfosBails_2_11_3_1.setHorizontalAlignment(SwingConstants.LEFT);
		lblInfosBails_2_11_3_1.setForeground(Color.BLACK);
		lblInfosBails_2_11_3_1.setFont(new Font("Times New Roman", Font.BOLD, 13));
		lblInfosBails_2_11_3_1.setBounds(553, 287, 120, 34);
		panel_2.add(lblInfosBails_2_11_3_1);

		JLabel lblInfosBails_2_1_10_3_1 = new JLabel("......");
		lblInfosBails_2_1_10_3_1.setHorizontalAlignment(SwingConstants.LEFT);
		lblInfosBails_2_1_10_3_1.setForeground(Color.BLACK);
		lblInfosBails_2_1_10_3_1.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblInfosBails_2_1_10_3_1.setBounds(683, 286, 105, 34);
		panel_2.add(lblInfosBails_2_1_10_3_1);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (comboBox.getSelectedItem().toString().equals("Maison")) {
					//Affichage de liste des biens disponibles déjà validés pour maison
					ArrayList<Maison> msnList = new ArrayList<Maison>();
					msnList = MaisonDAO.getListValide();
					...
					//Affichage de liste des biens disponibles déjà validés pour Appartement
					ArrayList<Appartement> appList = new ArrayList<Appartement>();
					appList = AppartementDAO.getListValide();
					String colonne[] = { "ID BIEN", "Statut" };
					DefaultTableModel model = new DefaultTableModel(null, colonne);
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				//Affichage des données du bien dans les JLabel pour chaque ligne sélectionnée
		...
		JButton btnNewButton = new JButton("FAIRE DEMANDE");
		btnNewButton.addActionListener(new ActionListener() {
			//Faire la demande pour le bien sélectionné
			public void actionPerformed(ActionEvent e) {
				if (comboBox.getSelectedItem().toString().equals("Maison")) {
					//Cas d'une maison
					msnDao.addDemande(LocataireDAO.get(locataire.getLct_id()).getLct_id_locataire(), lblInfosBails_2_1_6.getText());

				} else if (comboBox.getSelectedItem().toString().equals("Appartement")) {
					//Cas d'un appartement
					appDao.addDemande(LocataireDAO.get(locataire.getLct_id()).getLct_id_locataire(), lblInfosBails_2_1_6.getText());
				}
			}
		});
		btnNewButton.setForeground(Color.GREEN);
		btnNewButton.setBounds(472, 406, 121, 38);
