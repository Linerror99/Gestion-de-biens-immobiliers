...
public class SuiviDemandeDepot {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				 Bailleur agent = new Bailleur("p", "p", "p");
				try {
					SuiviDemandeDepot window = new SuiviDemandeDepot(agent);
	 ...
	 */
	public SuiviDemandeDepot(Bailleur agent) {
		initialize(agent);
	}
	 ...
	 */
	private void initialize(Bailleur agent) {

		frame = new JFrame();
		frame.setTitle("Suivi de demande de dépôt de bien immobilier");
		...
		JLabel lblNewLabel_1 = new JLabel(agent.getBllr_nom());
		...
		JLabel lblNewLabel_1_1 = new JLabel(agent.getBllr_prenom());
		...
		JLabel lblNewLabel_1_1_1 = new JLabel(agent.getBllr_id());
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					EspaceBailleur window = new EspaceBailleur(agent);
					window.frame.setVisible(true);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		panel_2.setBounds(430, 32, 824, 364);
		panel_1.add(panel_2);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (comboBox.getSelectedItem().toString().equals("Maison")) {
					...
					String check = BailleurDAO.get(agent.getBllr_id()).getBllr_id_bailleur();
					msnList = MaisonDAO.getListbailleur(check);
					...
					String check = BailleurDAO.get(agent.getBllr_id()).getBllr_id_bailleur();
					appList = AppartementDAO.getListbailleur(check);
					String colonne[] = { "ID BIEN", "Statut" };
					DefaultTableModel model = new DefaultTableModel(null, colonne);
		...
		JButton btnNewButton_1_1_1 = new JButton("Déposer un bien");
		btnNewButton_1_1_1.setBackground(new Color(154, 205, 50));
		btnNewButton_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					DepotdeBien window = new DepotdeBien(agent);
					window.frame.setVisible(true);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		btnNewButton_1_1_1.setBounds(440, 406, 171, 38);
