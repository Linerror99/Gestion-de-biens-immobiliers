...
public class InscriptionAgent {
	...
	private void initialize() {
		...
		frame = new JFrame();
		frame.setTitle("Inscription Agent");
		...
		btnAgent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textField_2.getText().equals("") || textField_3.getText().equals("") || textField_6.getText().equals("") || textField_4.getText().equals("") || textField_5.getText().equals("") || textField.getText().equals("") || textField_1.getText().equals("") || textField_7.getText().equals("")  ) {
					JOptionPane.showMessageDialog(new JFrame(), "Veuillez remplir tous les champs !",
							"Champs obligatoires", JOptionPane.ERROR_MESSAGE);
				}else {
				Agent bllr = new Agent(textField_2.getText(),textField_3.getText(), Integer.parseInt(textField_6.getText()), textField_4.getText(), textField_5.getText(), textField.getText(), textField_1.getText(), textField_7.getText());
				AgentDAO bllrDao = new AgentDAO ();
				bllrDao.add(bllr);
				textField_2.setText("");
				textField_3.setText(""); 
				textField_6.setText("");
		...
		btnAgent.setBounds(514, 359, 318, 66);
		panel.add(btnAgent);
		...
		JLabel lblNewLabel_1_1_5_1 = new JLabel("AGENT CODE");
		lblNewLabel_1_1_5_1.setFont(new Font("Times New Roman", Font.BOLD, 16));
		lblNewLabel_1_1_5_1.setBounds(630, 138, 129, 36);
