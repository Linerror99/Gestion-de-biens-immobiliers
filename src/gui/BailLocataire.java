...
public class BailLocataire {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				Locataire lct = new Locataire("p", "p", "p");
				try {
					BailLocataire window = new BailLocataire(lct);
	 ...
	 */
	public BailLocataire(Locataire lct) {
		initialize(lct);
	}
	 ...
	 */
	private void initialize(Locataire lct) {

		frame = new JFrame();
		frame.setTitle("Bails du Locataire");
		...
		JLabel lblNewLabel_1 = new JLabel(lct.getLct_nom());
		...
		JLabel lblNewLabel_1_1 = new JLabel(lct.getLct_prenom());
		...
		JLabel lblNewLabel_1_1_1 = new JLabel(lct.getLct_id_locataire());
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					EspaceLocataire window = new EspaceLocataire(lct);
					window.frame.setVisible(true);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ArrayList<Lie> lieList = new ArrayList<Lie>();
				lieList = LieDAO.getListLocataire(LocataireDAO.get(lct.getLct_id()).getLct_id_locataire());
				String colonne[] = { "ID BAIL", "ID LOCATAIRE" };
				DefaultTableModel model = new DefaultTableModel(null, colonne);
				for (int i = 0; i < lieList.size(); i++) {
					Object o[] = { lieList.get(i).getLie_bl_id(), lieList.get(i).getLie_lct_id() };
					model.addRow(o);
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				Bailleur bailleur = BailleurDAO.gets(lblInfosBails_2_1_6_1_1.getText());
